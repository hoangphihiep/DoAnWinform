namespace DuLich
{
    partial class fHotel_Posting_Image
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(fHotel_Posting_Image));
            panel2 = new Panel();
            lbl_Dang = new Label();
            lbl_HoSo = new Label();
            lbl_Anh = new Label();
            ...
            panel1.Controls.Add(lbl_HinhAnhRatQuanTrong);
            panel1.Controls.Add(btn_TiepTheo);
            panel1.Controls.Add(lbl_ChonLoaiHinh);
            panel1.Controls.Add(lbl_MatNgoai);
            ...
            label1.Location = new Point(75, 155);
            label1.Name = "label1";
            label1.Size = new Size(336, 20);
            label1.TabIndex = 69;
            label1.Text = "* Mẹo tối thiểu 800x600px - lí tưởng 2048-1536px*";
            ...
            lbl_ChoKhachHangXem.Click += lbl_ThietLap_Click;
            // 
            // fHotel_Posting_Image
            // 
            ...
            Controls.Add(panel2);
            Controls.Add(panel1);
            Name = "fHotel_Posting_Image";
            StartPosition = FormStartPosition.CenterScreen;
            Text = " Ảnh";
            Load += fHotel_Posting_Image_Load;
