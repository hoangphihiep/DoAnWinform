namespace DuLich
{
    partial class Customer_Information
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lbl_SoDienThoai = new Label();
            label1 = new Label();
            this.txt_TenDayDu = new TextBox();
            ...
            panel1.Controls.Add(this.lbl_TenDayDu);
            panel1.Controls.Add(lbl_QuocGia);
            panel1.Controls.Add(lbl_DiaDiem);
            panel1.Controls.Add(lbl_Email);
            panel1.Controls.Add(txt_Email);
            panel1.Controls.Add(this.lbl_SoDienThoai);
            panel1.Controls.Add(label1);
            panel1.Controls.Add(this.txt_TenDayDu);
