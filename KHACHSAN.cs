...
namespace DuLich
{
    public class KHACHSAN
    {
        ...
        public KHACHSAN(int maks, string tenKS, string tinh, string thanhPho, int sao, double gia, string diaChi, int soLuong, int TP, int SanBay, string Anh, int maKS, DateTime ngayDen, DateTime ngayDi)
        {
